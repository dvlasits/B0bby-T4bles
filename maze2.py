...
def run():
	...
	if DEMO:
		...
		FuncToStayMid = robot.stayMid2
		FuncToStayMid = newJustMidMazeSide.StayMid
		start = time.time()
		...
		FuncToStayMid(false,20,rightSide=False,maxSpeed=speed,targetHeading=absHeading-90,numBefore = 1,RightHigh = True)
		print("4th start deg")
		...
		robot.stayDeg("turned",absHeading-90,absolute=True,maxSpeed=speed)
		print("4th stay mid")
		newJustMid.StayMid(false,20,rightSide=True,maxSpeed=speed,targetHeading=absHeading-90,numBefore = 3)
		print("6th stayDeg")
		robot.stayDeg("turned",absHeading-180,absolute=True,maxSpeed=speed)
		print("5th staymid")
		FuncToStayMid(false,20,rightSide=True,maxSpeed=speed,targetHeading=absHeading-180,numBefore = 19)
		print("7th stayDeg")
		robot.stayDeg("turned",absHeading+90,absolute=True,maxSpeed=speed)
		print("6th staymid")
		FuncToStayMid(false,20,rightSide=True,maxSpeed=speed,targetHeading=absHeading+90,numBefore=25,RightHigh = True)
		heading=90
		robot.stop()
