...
def StayMid(useless1, useless2, maxSpeed = 1,targetHeading = robot.compass.Heading(),rightSide=True,DisToBe=16,threshold=4,useUltras = True,StoppingDis = 55,numBefore = 15,RightHigh = False):
